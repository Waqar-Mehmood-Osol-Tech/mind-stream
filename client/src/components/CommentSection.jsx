...
//             </p>
//             <Button outline  className='bg-purple-900 hover:!bg-purple-600' type='submit'>
//               Submit
//             </Button>
//           </div>
//           {commentError && (
...
//             <button
//               type="submit"
//               className="px-4 py-2 bg-purple-900 text-white rounded-md hover:bg-purple-600 transition"
//             >
//               Submit
//             </button>
//           </div>
//           {commentError && (
//             <div className="mt-5 p-2 text-red-500 text-sm border border-red-500 rounded-md">
//               {commentError}
//             </div>
//           )}
//         </form>
  ...
  return (
    <div className="max-w-2xl mx-auto w-full p-3">
      ...
      {currentUser && (
        <form
          onSubmit={handleSubmit}
          className="border border-purple-900 rounded-md p-3"
        >
          <textarea
            placeholder="Add a comment..."
            rows="3"
